...
rules <- apriori(trans_category, parameter = list(supp = 0.01, conf = 0.95, minlen = 2, maxlen = 10)) #first rules using supp = 0.001 and
...
#-to find strong rules, increase the value of âconfâ parameter
