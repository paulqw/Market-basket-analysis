...
```{r Portfolio comparison, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 7, fig.asp = 0.7, fig.align = 'center'}
...
ggplot(merged_portfolios, aes(x = category, y = portion)) + 
          facet_grid(company ~.) + 
...
```{r Visualization of cluster analysis, echo=FALSE, message=FALSE, warning=FALSE, results = 'hide', fig.width = 5, fig.asp = 0.7}
# Visualization 
...
```{r itemFrequ for b2c b2b, echo=FALSE, message=FALSE, warning=FALSE, results = 'hide', fig.align = 'center', fig.width = 7, fig.asp = 0.7, fig.align = 'center'}
...
```{r Visualization - Scatter, echo=FALSE, message=FALSE, warning=FALSE, results='hide', fig.width = 5, fig.asp = 0.7, fig.align = 'center'}
